describe("ProtheusOrderService", function () {
  var ProtheusOrderService, SalesforceService, ProtheusOrder, $q

  beforeEach(module('cartaFabril'))

  beforeEach(inject(function (_$q_, _ProtheusOrder_, _SalesforceService_, _ProtheusOrderService_) {
    $q = _$q_
    ProtheusOrder = _ProtheusOrder_
    SalesforceService = _SalesforceService_
    ProtheusOrderService = _ProtheusOrderService_
  }))
  ...
  describe("#loadList", function () {
    ...
    it("calls SalesforceSerive#loadData with the right params", function () {
      ProtheusOrderService.loadList(clientId)
